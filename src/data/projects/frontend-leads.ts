...
export const frontendLeads: Project = {
  ...
  prints: [
    {
      src: "/prints/frontend-leads/home.png",
      legenda: "Home do gerenciador de leads",
    },
    {
      src: "/prints/frontend-leads/atendimento.png",
      legenda: "Atendimento ao cliente",
    },
  ],
};