...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descricao:
      "Projeto Interdisciplinar do 1º semestre, desenvolvido em equipe, com a proposta de construir um site de turismo ecológico apresentando pontos turísticos de natureza. A página é 100% estática, composta por HTML, CSS e JavaScript, com páginas individuais para cada destino que incluem textos, imagens e mapas, além de menus responsivos e carrossel de fotos. Trabalhei no desenvolvimento das páginas com HTML semântico, estilização com Flexbox e interações no DOM com JavaScript. O site possui páginas como Cachoeira do Elefante, Cachoeira do Guaratuba, Mirante Itaguaçu, Rio Jaguareguava, Torre 47, Trilha d'Água e Vale Verde.",
    ...
    stats: [
      { label: "HTML", value: 5 },
      { label: "CSS (Flexbox)", value: 3 },
      { label: "JavaScript (DOM)", value: 2 },
    ],
    aprendizados: [
